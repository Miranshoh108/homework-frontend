          ...
          product.sales_product.map((item, index) => (
            ...
            >
              ...
              <button
                onClick={() =>
                  handleDownload(
                    `${import.meta.env.VITE_BASE_URL}/uploads/${item.sales_document[index]
                    }`,
          ...
          product.document_product.map((item, index) => (
            ...
            >
              ...
              <button
                onClick={() =>
                  handleDownload(
                    `${import.meta.env.VITE_BASE_URL}/uploads/${item.document_img[0]
                    }`,
