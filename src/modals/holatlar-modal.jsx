...
export default function EventsModal({ setConfirm }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!editData?.id && !formData.offender_full_name) {
      notification("Huquq buzgan shaxsni kiriting");
      return;
    }
          ...
          <div className="flex flex-col gap-4">
            ...
            {!editData?.id && (
              <div className="flex flex-col gap-1.5">
                ...
                >
                  Huquq buzar <span className="text-red-500">*</span>
                </label>
                <input
            ...
            <div className="flex justify-end gap-4 mt-6">
              <button
                type="button"
                onClick={onClose}
                className="px-6 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-colors max-[350px]:px-2"
              >
                Bekor qilish
              </button>
              <button
